...
<head>
  ...
  <title>Dashboard | NameLogo</title>
</head>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12 mt-4 mx-3 h4">
              <strong class="p-3">Add you logo text <i class="my-blue far fa-id-card"></i></strong>
            </div>
          </div>
                  ...
                  <form action="" method="POST">
                    <table>
                      <tr>
                        ...
                        <td><input class="form-control my-3 mx-3" type="text" name="name" placeholder="Name Logo" /></td>
                      </tr>
                      <tr>
