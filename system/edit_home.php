...
<body>
    <form action="" method="POST" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                <td>Youtube</td>
                <td><input type="text" name="youtube" id="youtube" value="<?= isset($selectedData) ? $selectedData->youtube : '' ?>" /></td>
            </tr>
            <tr>
                <td>Git</td>
                <td><input type="text" name="git" id="git" value="<?= isset($selectedData) ? $selectedData->git : '' ?>" /></td>
            </tr>
            <tr>
                <td>Image</td>
                <td>
